...

{
       ...
       // ✅ Check admin authentication (same as other methods)
...

{
    ...
    // View में dropdown के लिए चाहिए

    $courses = $admissionModel->distinct()->select('course')->findAll();

    $years = $admissionModel->select("YEAR(admission_date) AS year")->distinct()->orderBy('year', 'desc')->findAll();
    ...
    return view('admin/fees/add', [
        ...
        'selectedYear' => date('Y', strtotime($student['admission_date']))
