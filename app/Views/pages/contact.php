                ...
                <div class="card text-white bg-danger h-100 shadow">
                    <div class="card-body text-center">
                        ...
                        <div class="d-flex justify-content-center gap-2">
                            <a href="https://www.facebook.com/aruncomputersrewa" class="text-white"><i class="bi bi-facebook fs-4"></i></a>
                            <a href="#" class="text-white"><i class="bi bi-instagram fs-4"></i></a>
                            <a href="https://wa.me/9201488597" class="text-white"><i class="bi bi-whatsapp fs-4"></i></a>
                        </div>
                    </div>
                </div>
            </div>
