    ...
    <div class="text-center">
        ...
        <div class="row g-2">
            ...
            <div class="col-4">
                ...
                <img src="<?= base_url('assets/images/lab1.jpg') ?>" class="img-fluid rounded object-fit-cover" style="height:150px;" alt="Lab 1">

            </div>

            <div class="col-4">

                <img src="<?= base_url('assets/images/lab2.jpg') ?>" class="img-fluid rounded object-fit-cover" style="height:150px;" alt="Lab 2">

            </div>

            <div class="col-4">

                <img src="<?= base_url('assets/images/lab3.jpg') ?>" class="img-fluid rounded object-fit-cover" style="height:150px;" alt="Lab 3">
