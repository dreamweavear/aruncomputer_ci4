    ...
    enctype="multipart/form-data">
        ...
        <div class="row">
            <div class="col-md-6 mb-3">
                ...
                <input type="number" name="course_fee" class="form-control" required min="0" step="0.01"
                    value="<?= old('course_fee', $student['course_fee'] ?? '') ?>">
            </div>
            <div class="col-md-6 mb-3">
                <label>Discount</label>
                <input type="number" name="discount" class="form-control" required min="0" step="0.01"
        ...
        <div class="row">
            ...
            <div class="col-md-6 mb-3">
                ...
                <input type="number" name="admission_fee" class="form-control" required min="0" step="0.01"
        ...
        <div class="row">
            <div class="col-md-6 mb-3">
                ...
                <input type="number" name="receipt_number" class="form-control" required min="1"
                    value="<?= old('receipt_number', $student['receipt_number'] ?? '') ?>">
            </div>
            <div class="col-md-6 mb-3">
                <label>Payment Mode (First Installment)</label>
                <select name="admission_payment_mode" class="form-control" required>
                    <option value="Cash" <?= old('admission_payment_mode', 'Cash') == 'Cash' ? 'selected' : '' ?>>Cash</option>
                    <option value="Cheque" <?= old('admission_payment_mode') == 'Cheque' ? 'selected' : '' ?>>Cheque</option>
                    <option value="Bank Transfer" <?= old('admission_payment_mode') == 'Bank Transfer' ? 'selected' : '' ?>>Bank Transfer</option>
                    <option value="Online" <?= old('admission_payment_mode') == 'Online' ? 'selected' : '' ?>>Online</option>
                    <option value="DD" <?= old('admission_payment_mode') == 'DD' ? 'selected' : '' ?>>DD (Demand Draft)</option>
                </select>
            </div>
        </div>
