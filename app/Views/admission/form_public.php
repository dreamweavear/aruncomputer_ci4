...
<div class="container mt-4">
    ...
    <form id="enquiryForm" method="post" action="<?= base_url('admissionpage/store') ?>" novalidate>
        <?= csrf_field() ?>

        <div class="mb-3">
            <label class="form-label">Course <span class="text-danger">*</span></label>
            <select class="form-select <?= isset($validation) && $validation->hasError('course') ? 'is-invalid' : '' ?>"
        ...
        <div class="mb-3">
            ...
            <input type="date"
                   class="form-control <?= isset($validation) && $validation->hasError('dob') ? 'is-invalid' : '' ?>"
                   name="dob" required
