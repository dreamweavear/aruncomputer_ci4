...
img, video {
    ...
    /* General dropdown hover style (your theme) */
    .dropdown-item:hover { background:linear-gradient(90deg, rgba(0,120,215,.1), rgba(255,255,255,0)); color:#0078D7 !important; }
    .dropdown-item:active { background:#0078D7 !important; color:#fff !important; }
  </style>
