    ...
    <tbody>
        ...
        <?php foreach ($fees as $fee): ?>
            ...
            <tr>
                ...
                <td><?= esc($fee['payment_mode'] ?? 'Cash') ?></td>
                ...
                <td>
                    ...
                    <span class="badge bg-<?= $color ?>"><?= esc($status) ?></span>
            ...
            <td>
                ...
                <a href="<?= site_url('admin/fees/edit/'.$fee['id']) ?>" 
                ...
                <form method="post"
                      ...
                      action="<?= site_url('admin/fees/delete/'.$fee['id']) ?>"

                      style="display:inline;"

                      onsubmit="return confirm('Is fee record ko delete karna hai?');">
                ...
                <a href="<?= site_url('admin/fees/view/' . $fee['student_id']) ?>" 
