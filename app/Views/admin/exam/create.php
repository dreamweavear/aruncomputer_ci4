...
<div class="d-flex justify-content-between align-items-center mb-3 border-bottom pb-2">
    <h2 class="text-primary mb-0">
        ...
        <small class="fs-6 text-muted ms-2">Attempt #<?= $nextAttempt ?></small>
    </h2>
...
<div class="card shadow-sm">
    <div class="card-header bg-light fw-bold">
        <i class="bi bi-clipboard-data me-2"></i>Enter Marks (Each paper out of 50)
    </div>
    <div class="card-body">
        <form action="<?= site_url('admin/exam/store') ?>" method="post" id="marksForm">
            <?= csrf_field() ?>
            ...
            <div class="row g-3">
                <div class="col-md-4">
                    ...
                    <input type="number" name="theory_marks" id="theory" class="form-control form-control-lg"
                           min="0" max="50" placeholder="0–50" required
            ...
            <div class="card mt-4 bg-light border-0">
                <div class="card-body">
                    <div class="row text-center">
                        <div class="col-3">
                            <div class="fs-4 fw-bold text-primary" id="totalDisplay">0</div>
                            <div class="small text-muted">Total / 100</div>
                        </div>
                        <div class="col-3">
                            <div class="fs-4 fw-bold text-info" id="pctDisplay">0.00%</div>
